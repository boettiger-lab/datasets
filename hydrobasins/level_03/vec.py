...
def main():
    parser = argparse.ArgumentParser(description="Process HydroBasins level 3 into H3 hexes")
    ...
    parser.add_argument("--input-url", default="s3://public-hydrobasins/level_03.parquet", help="Input geoparquet file")
    parser.add_argument("--output-url", default="s3://public-hydrobasins/level_03/chunks", help="Output geoparquet bucket")
