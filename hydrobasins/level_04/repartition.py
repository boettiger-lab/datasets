...
(con
    .read_parquet("s3://public-hydrobasins/level_04/chunks/*.parquet")
...
(con
    ...
    .to_parquet("s3://public-hydrobasins/level_04/hexes/", partition_by="h0")
)
...
try:
    ...
    result = subprocess.run(
        ["mc", "rm", "--recursive", "--force", "s3/public-hydrobasins/level_04/chunks/"],
        capture_output=True,
        text=True,
        timeout=300
    )
    if result.returncode == 0:
        ...
        result = subprocess.run(
            ["aws", "s3", "rm", "s3://public-hydrobasins/level_04/chunks/", "--recursive",
