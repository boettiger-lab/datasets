...
def main():
    parser = argparse.ArgumentParser(description="Process HydroBasins level 6 into H3 hexes")
    ...
    parser.add_argument("--input-url", default="s3://public-hydrobasins/level_06.parquet", help="Input geoparquet file")
    parser.add_argument("--output-url", default="s3://public-hydrobasins/level_06/chunks", help="Output geoparquet bucket")
