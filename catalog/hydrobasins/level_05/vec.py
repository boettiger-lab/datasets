...
def main():
    parser = argparse.ArgumentParser(description="Process HydroBasins level 5 into H3 hexes")
    ...
    parser.add_argument("--input-url", default="s3://public-hydrobasins/level_05.parquet", help="Input geoparquet file")
    parser.add_argument("--output-url", default="s3://public-hydrobasins/level_05/chunks", help="Output geoparquet bucket")
