...
(con
    .read_parquet("s3://public-redlining/chunks/*.parquet")
...
(con
    ...
    .to_parquet("s3://public-redlining/hex/", partition_by="h0")
)
...
try:
    ...
    result = subprocess.run(
        ["mc", "rm", "--recursive", "--force", "s3/public-redlining/chunks/"],
        capture_output=True,
        text=True,
        timeout=300
    )
    if result.returncode == 0:
        ...
        result = subprocess.run(
            ["aws", "s3", "rm", "s3://public-redlining/chunks/", "--recursive",
