...
# hexes
redlining <- open_dataset("s3://public-mappinginequality/hex") |>
    mutate(h0 = as.character(h0))
...
polys <- open_dataset(
    "s3://public-redlining/mappinginequality.parquet",
    recursive = FALSE
) |>
    mutate(
        geom = ST_Transform(
            ST_FlipCoordinates(st_MakeValid(geometry)),
            "EPSG:4326",
            "EPSG:5070"
        )
    ) |> # lots are lost
